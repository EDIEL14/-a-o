    ...
    <h1 class="text-center">Formulario para Pagar</h1>
            ...
            <form method="post">
                ...
                <div id="form-tarjeta" class="payment-details" style="display:none;">
                    ...
                    <!-- Barra lateral de opciones de pago -->
        <div class="col-md-4">
            <div class="payment-options">
                <h2 class="text-center">Pago a Meses Con o Sin Intereses</h2>

                <?php
                // Precio base dependiendo del tipo de propiedad
                $precio = isset($plano) ? $plano['precio'] : (isset($condominio) ? $condominio['precio'] : $departamento['precio']);

                // Función para calcular cuotas con y sin intereses
                ...
                <div>
                    <h3>SIN INTERESES:</h3>
                    <h4><img src="/imagenes/bancos/bbva.png" alt="BBVA" width="50"> BBVA</h4>
                    ...
                    <h4><img src="/imagenes/bancos/santander.jpg" alt="Santander" width="50"> Santander</h4>
                    <p>3 meses: $<?php echo calcularCuotas($precio, 3, 9); ?>/mes</p>
                    <p>6 meses: $<?php echo calcularCuotas($precio, 6, 8); ?>/mes</p>
                    <p>12 meses: $<?php echo calcularCuotas($precio, 12, 20); ?>/mes</p>

                    <h4><img src="/imagenes/bancos/scotiabank.jpg" alt="Scotiabank" width="50"> Scotiabank</h4>
                    <p>6 meses: $<?php echo calcularCuotas($precio, 6); ?>/mes</p>
                    <p>12 meses: $<?php echo calcularCuotas($precio, 12); ?>/mes</p>

                    <h4><img src="/imagenes/bancos/invex.png" alt="INVEX" width="50"> INVEX</h4>
                    <p>12 meses: $<?php echo calcularCuotas($precio, 12); ?>/mes</p>
                    <p>18 meses: $<?php echo calcularCuotas($precio, 18); ?>/mes</p>
                ...
                <div>
                    <h3>CON INTERESES:</h3>
                    <h4><img src="/imagenes/bancos/bbva.png" alt="BBVA" width="50"> BBVA</h4>
                    <p>3 meses: $<?php echo calcularCuotas($precio, 3, 38); ?>/mes (interés)</p>
                    <p>6 meses: $<?php echo calcularCuotas($precio, 6, 24); ?>/mes (interés)</p>
                    <p>12 meses: $<?php echo calcularCuotas($precio, 12, 48); ?>/mes (interés)</p>
                    <p>18 meses: $<?php echo calcularCuotas($precio, 18, 72); ?>/mes (interés)</p>

                    <h4><img src="/imagenes/bancos/santander.jpg" alt="Santander" width="50"> Santander</h4>
                    <p>3 meses: $<?php echo calcularCuotas($precio, 3, 75); ?>/mes (interés)</p>
                    <p>6 meses: $<?php echo calcularCuotas($precio, 6, 80); ?>/mes (interés)</p>
                    <p>12 meses: $<?php echo calcularCuotas($precio, 12, 92); ?>/mes (interés)</p>

                    <h4><img src="/imagenes/bancos/scotiabank.jpg" alt="Scotiabank" width="50"> Scotiabank</h4>
                    <p>6 meses: $<?php echo calcularCuotas($precio, 6, 32); ?>/mes (interés)</p>
                    <p>12 meses: $<?php echo calcularCuotas($precio, 12, 68); ?>/mes (interés)</p>

                    <h4><img src="/imagenes/bancos/invex.png" alt="INVEX" width="50"> INVEX</h4>
                    <p>12 meses: $<?php echo calcularCuotas($precio, 12, 44); ?>/mes (interés)</p>
                    <p>18 meses: $<?php echo calcularCuotas($precio, 18, 80); ?>/mes (interés)</p>
                    <p>24 meses: $<?php echo calcularCuotas($precio, 24, 92); ?>/mes (interés)</p>
                </div>
            </div>
        </div>
